...
# /home/eugene/homogeneous_port/hthread_hal/src/platforms/xilinx/ml507_cell/design/system.mhs
# The software specification of the system is in file :
# /home/eugene/homogeneous_port/hthread_hal/src/platforms/xilinx/ml507_cell/design/system.mss
...
microblaze_2a_libsclean:
	rm -rf microblaze_2a/

microblaze_3a_libsclean:
	rm -rf microblaze_3a/
...
hist_thread_program: $(HIST_THREAD_OUTPUT) 

$(HIST_THREAD_OUTPUT) : $(HIST_THREAD_SOURCES) $(HIST_THREAD_HEADERS) $(HIST_THREAD_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/hist_thread_compiler.opt
	@mkdir -p $(HIST_THREAD_OUTPUT_DIR) 
	$(HIST_THREAD_CC) $(HIST_THREAD_CC_OPT) $(HIST_THREAD_SOURCES) -o $(HIST_THREAD_OUTPUT) \
	$(HIST_THREAD_OTHER_CC_FLAGS) $(HIST_THREAD_INCLUDES) $(HIST_THREAD_LIBPATH) \
	$(HIST_THREAD_CFLAGS) $(HIST_THREAD_LFLAGS) 
	$(HIST_THREAD_CC_SIZE) $(HIST_THREAD_OUTPUT) 
	@echo ""

hist_thread_programclean:
	rm -f $(HIST_THREAD_OUTPUT) 
...
$(MICROBLAZE_2A_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE_2A_BOOTLOOP)

$(MICROBLAZE_3A_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(MICROBLAZE_3A_BOOTLOOP)
