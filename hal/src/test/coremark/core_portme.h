...
#endif
#ifndef MEM_LOCATION 
 #define MEM_LOCATION "Code in DDR"
...
/* Configuration: USE_PTHREAD
	...
	This implementation uses hthread_thread_create and hthread_join.
	
	Valid values:
	0 - Do not use hthreads API.
	1 - Use hthreads API
...
#if USE_PTHREAD
	#include <hthread.h>
	#define PARALLEL_METHOD "HThreads"
#elif USE_FORK
	#include <unistd.h>
	#include <errno.h>
	#include <sys/wait.h>
