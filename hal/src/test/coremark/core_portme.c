...
/* Function: core_start_parallel
	...
	Three implementations are provided, one using hthreads, one using fork and shared mem, and one using fork and sockets.
...
ee_u8 core_start_parallel(core_results *res) {
	return (ee_u8)hthread_create(&(res->port.thread),NULL,iterate,(void *)res);
}
ee_u8 core_stop_parallel(core_results *res) {
	void *retval;
	return (ee_u8)hthread_join(res->port.thread,&retval);
}
