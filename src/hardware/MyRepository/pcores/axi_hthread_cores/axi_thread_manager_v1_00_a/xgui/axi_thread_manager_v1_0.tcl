...
proc init_gui { IPINST } {
	...
	set C_RESET_TIMEOUT [ipgui::add_param $IPINST -parent $Page0 -name C_RESET_TIMEOUT]
}
...
proc update_PARAM_VALUE.C_RESET_TIMEOUT { PARAM_VALUE.C_RESET_TIMEOUT } {
	# Procedure called to update C_RESET_TIMEOUT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_RESET_TIMEOUT { PARAM_VALUE.C_RESET_TIMEOUT } {
	# Procedure called to validate C_RESET_TIMEOUT
	return true
}


proc update_MODELPARAM_VALUE.C_RESET_TIMEOUT { MODELPARAM_VALUE.C_RESET_TIMEOUT PARAM_VALUE.C_RESET_TIMEOUT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_RESET_TIMEOUT}] ${MODELPARAM_VALUE.C_RESET_TIMEOUT}
}
