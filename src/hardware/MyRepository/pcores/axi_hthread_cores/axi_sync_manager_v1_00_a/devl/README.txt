...
Peripheral Summary:
  ...
  XPS project / EDK repository               : /home/abazar63/hthread/src/platforms/xilinx/vc707_smp1_axi_cores/design
  logical library name                       : axi_scheduler_v1_00_a
  top name                                   : axi_scheduler
  version                                    : 1.00.a
...
- ISE project file(s)
  ...
  devl/projnav/axi_scheduler.xise
...
- XST synthesis file(s)
  ...
  devl/synthesis/axi_scheduler_xst.prj
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/axi_scheduler_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/axi_scheduler_v2_1_0.tcl
