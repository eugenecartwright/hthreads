...
proc init_gui { IPINST } {
	...
	set C_M_AXI_LITE_DATA_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_M_AXI_LITE_DATA_WIDTH]
	set C_M_AXI_LITE_ADDR_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_M_AXI_LITE_ADDR_WIDTH]
	...
	set C_SCHED_HADDR [ipgui::add_param $IPINST -parent $Page0 -name C_SCHED_HADDR]
	set C_SCHED_BADDR [ipgui::add_param $IPINST -parent $Page0 -name C_SCHED_BADDR]
	set C_NUM_MUTEXES [ipgui::add_param $IPINST -parent $Page0 -name C_NUM_MUTEXES]
	set C_NUM_THREADS [ipgui::add_param $IPINST -parent $Page0 -name C_NUM_THREADS]
}
...
proc update_PARAM_VALUE.C_SCHED_HADDR { PARAM_VALUE.C_SCHED_HADDR } {
	# Procedure called to update C_SCHED_HADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_SCHED_HADDR { PARAM_VALUE.C_SCHED_HADDR } {
	# Procedure called to validate C_SCHED_HADDR
	return true
}

proc update_PARAM_VALUE.C_SCHED_BADDR { PARAM_VALUE.C_SCHED_BADDR } {
	# Procedure called to update C_SCHED_BADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_SCHED_BADDR { PARAM_VALUE.C_SCHED_BADDR } {
	# Procedure called to validate C_SCHED_BADDR
	return true
}

proc update_PARAM_VALUE.C_NUM_MUTEXES { PARAM_VALUE.C_NUM_MUTEXES } {
	# Procedure called to update C_NUM_MUTEXES when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_NUM_MUTEXES { PARAM_VALUE.C_NUM_MUTEXES } {
	# Procedure called to validate C_NUM_MUTEXES
	return true
}

proc update_PARAM_VALUE.C_NUM_THREADS { PARAM_VALUE.C_NUM_THREADS } {
	# Procedure called to update C_NUM_THREADS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_NUM_THREADS { PARAM_VALUE.C_NUM_THREADS } {
	# Procedure called to validate C_NUM_THREADS
	return true
}


proc update_MODELPARAM_VALUE.C_NUM_THREADS { MODELPARAM_VALUE.C_NUM_THREADS PARAM_VALUE.C_NUM_THREADS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_NUM_THREADS}] ${MODELPARAM_VALUE.C_NUM_THREADS}
}

proc update_MODELPARAM_VALUE.C_NUM_MUTEXES { MODELPARAM_VALUE.C_NUM_MUTEXES PARAM_VALUE.C_NUM_MUTEXES } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_NUM_MUTEXES}] ${MODELPARAM_VALUE.C_NUM_MUTEXES}
}

proc update_MODELPARAM_VALUE.C_SCHED_BADDR { MODELPARAM_VALUE.C_SCHED_BADDR PARAM_VALUE.C_SCHED_BADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_SCHED_BADDR}] ${MODELPARAM_VALUE.C_SCHED_BADDR}
}

proc update_MODELPARAM_VALUE.C_SCHED_HADDR { MODELPARAM_VALUE.C_SCHED_HADDR PARAM_VALUE.C_SCHED_HADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_SCHED_HADDR}] ${MODELPARAM_VALUE.C_SCHED_HADDR}
}
