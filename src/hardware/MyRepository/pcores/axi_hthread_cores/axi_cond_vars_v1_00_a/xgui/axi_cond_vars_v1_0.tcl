...
proc init_gui { IPINST } {
	...
	set C_TM_BASE [ipgui::add_param $IPINST -parent $Page0 -name C_TM_BASE]
}
...
proc update_PARAM_VALUE.C_TM_BASE { PARAM_VALUE.C_TM_BASE } {
	# Procedure called to update C_TM_BASE when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_TM_BASE { PARAM_VALUE.C_TM_BASE } {
	# Procedure called to validate C_TM_BASE
	return true
}


proc update_MODELPARAM_VALUE.C_TM_BASE { MODELPARAM_VALUE.C_TM_BASE PARAM_VALUE.C_TM_BASE } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_TM_BASE}] ${MODELPARAM_VALUE.C_TM_BASE}
}
