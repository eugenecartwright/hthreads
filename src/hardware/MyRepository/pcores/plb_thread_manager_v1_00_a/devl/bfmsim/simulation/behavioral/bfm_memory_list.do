...
#
#  File     bfm_memory_list.do (Fri Apr 24 15:41:43 2009)
#
...
# eval add list $hexopt $tbpath${ps}bfm_memory${ps}PLB_reqPri
  ...
  eval add list $binopt $tbpath${ps}bfm_memory${ps}Sl_MBusy
  eval add list $binopt $tbpath${ps}bfm_memory${ps}Sl_MRdErr
  eval add list $binopt $tbpath${ps}bfm_memory${ps}Sl_MWrErr
  eval add list $binopt $tbpath${ps}bfm_memory${ps}Sl_MIRQ
