...
#
#  File     bfm_monitor_wave.do (Fri Apr 24 15:41:43 2009)
#
...
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_MTimeout
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_MBusy
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_MRdErr
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_MWrErr
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_MIRQ
...
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}PLB_rdPrim
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_monitor${ps}PLB_wrPrim
...
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_SMRdErr
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_SMWrErr
# eval add wave -noupdate $binopt $tbpath${ps}bfm_monitor${ps}PLB_SMIRQ
