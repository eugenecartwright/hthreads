------------------------------------------------------------------------------
-- plb_scheduler_smp.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
--
------------------------------------------------------------------------------
-- Filename:          plb_scheduler_smp.vhd
-- Version:           1.00.a
...
library plb_scheduler_smp_v1_00_a;
use plb_scheduler_smp_v1_00_a.user_logic;
...
end entity plb_scheduler_smp;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plb_scheduler_smp is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb_scheduler_smp_v1_00_a.user_logic
    generic map
    (
