...
#
#  File     bfm_memory_wave.do (Fri Apr 24 15:41:43 2009)
#
...
# eval add wave -noupdate $hexopt $tbpath${ps}bfm_memory${ps}PLB_reqPri
  ...
  eval add wave -noupdate $binopt $tbpath${ps}bfm_memory${ps}Sl_MBusy
  eval add wave -noupdate $binopt $tbpath${ps}bfm_memory${ps}Sl_MRdErr
  eval add wave -noupdate $binopt $tbpath${ps}bfm_memory${ps}Sl_MWrErr
  eval add wave -noupdate $binopt $tbpath${ps}bfm_memory${ps}Sl_MIRQ
