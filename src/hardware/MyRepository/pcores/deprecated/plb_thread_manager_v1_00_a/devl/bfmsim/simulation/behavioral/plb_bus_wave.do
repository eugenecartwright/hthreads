...
#
#  File     plb_bus_wave.do (Fri Apr 24 15:41:43 2009)
#
...
# eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}SYS_Rst
  ...
  eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}SPLB_Rst
# eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}MPLB_Rst
...
# eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}Sl_MIRQ
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_MIRQ
  ...
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_MTimeout
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_MBusy
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_MRdErr
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_MWrErr
  ...
  eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}PLB_rdPrim
  ...
  eval add wave -noupdate $hexopt $tbpath${ps}plb_bus${ps}PLB_wrPrim
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_SaddrAck
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_SMRdErr
  eval add wave -noupdate $binopt $tbpath${ps}plb_bus${ps}PLB_SMWrErr
