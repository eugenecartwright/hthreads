...
#
#  File     my_core_list.do (Fri Apr 24 15:41:43 2009)
#
...
# eval add list $hexopt $tbpath${ps}my_core${ps}PLB_TAttribute
  ...
  eval add list $binopt $tbpath${ps}my_core${ps}Sl_MBusy
  eval add list $binopt $tbpath${ps}my_core${ps}Sl_MWrErr
  eval add list $binopt $tbpath${ps}my_core${ps}Sl_MRdErr
  eval add list $binopt $tbpath${ps}my_core${ps}Sl_MIRQ
