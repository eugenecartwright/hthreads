...
#
#  File     bfm_monitor_list.do (Fri Apr 24 15:41:43 2009)
#
...
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_MTimeout
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_MBusy
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_MRdErr
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_MWrErr
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_MIRQ
...
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}PLB_rdPrim
# eval add list $hexopt $tbpath${ps}bfm_monitor${ps}PLB_wrPrim
...
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_SMRdErr
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_SMWrErr
# eval add list $binopt $tbpath${ps}bfm_monitor${ps}PLB_SMIRQ
