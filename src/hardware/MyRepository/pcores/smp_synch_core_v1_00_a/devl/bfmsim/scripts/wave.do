...
add wave -noupdate -divider {smp_synch_core Peripheral Interface Signals}
...
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rst_Bus2IP_Reset
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rst_IP2Bus_WrAck
add wave -noupdate -format Logic /bfm_system/my_core/my_core/uut/rst_IP2Bus_Error
...
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg10
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg11
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg12
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg13
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg14
add wave -noupdate -format Literal -radix hexadecimal /bfm_system/my_core/my_core/uut/user_logic_i/slv_reg15
