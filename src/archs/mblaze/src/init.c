...
void _init_arch_specific(void)
{
    ...
    TRACE_PRINTF(TRACE_INFO, TRACE_INIT, "Initializing Caches (if defined)...\n");
...
#else
    TRACE_PRINTF(TRACE_INFO, TRACE_INIT, "Disabling Instruction Cache...\n");
...
#else
    TRACE_PRINTF(TRACE_INFO, TRACE_INIT, "Disabling Data Cache...\n");
