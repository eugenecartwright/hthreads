...
/* Definitions for peripheral MICROBLAZE_3A */
#define XPAR_MICROBLAZE_3A_SCO 0
#define XPAR_MICROBLAZE_3A_DATA_SIZE 32
#define XPAR_MICROBLAZE_3A_DYNAMIC_BUS_SIZING 1
#define XPAR_MICROBLAZE_3A_AREA_OPTIMIZED 0
#define XPAR_MICROBLAZE_3A_INTERCONNECT 1
#define XPAR_MICROBLAZE_3A_DPLB_DWIDTH 64
#define XPAR_MICROBLAZE_3A_DPLB_NATIVE_DWIDTH 32
#define XPAR_MICROBLAZE_3A_DPLB_BURST_EN 0
#define XPAR_MICROBLAZE_3A_DPLB_P2P 0
#define XPAR_MICROBLAZE_3A_IPLB_DWIDTH 64
#define XPAR_MICROBLAZE_3A_IPLB_NATIVE_DWIDTH 32
#define XPAR_MICROBLAZE_3A_IPLB_BURST_EN 0
#define XPAR_MICROBLAZE_3A_IPLB_P2P 0
#define XPAR_MICROBLAZE_3A_D_PLB 1
#define XPAR_MICROBLAZE_3A_D_OPB 0
#define XPAR_MICROBLAZE_3A_D_LMB 1
#define XPAR_MICROBLAZE_3A_I_PLB 1
#define XPAR_MICROBLAZE_3A_I_OPB 0
#define XPAR_MICROBLAZE_3A_I_LMB 1
#define XPAR_MICROBLAZE_3A_USE_MSR_INSTR 1
#define XPAR_MICROBLAZE_3A_USE_PCMP_INSTR 1
#define XPAR_MICROBLAZE_3A_USE_BARREL 0
#define XPAR_MICROBLAZE_3A_USE_DIV 0
#define XPAR_MICROBLAZE_3A_USE_HW_MUL 1
#define XPAR_MICROBLAZE_3A_USE_FPU 0
#define XPAR_MICROBLAZE_3A_UNALIGNED_EXCEPTIONS 0
#define XPAR_MICROBLAZE_3A_ILL_OPCODE_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_IOPB_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_DOPB_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_IPLB_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_DPLB_BUS_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_DIV_ZERO_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_FPU_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_FSL_EXCEPTION 0
#define XPAR_MICROBLAZE_3A_PVR 2
#define XPAR_MICROBLAZE_3A_PVR_USER1 0x00
#define XPAR_MICROBLAZE_3A_PVR_USER2 0xB0000300
#define XPAR_MICROBLAZE_3A_DEBUG_ENABLED 1
#define XPAR_MICROBLAZE_3A_NUMBER_OF_PC_BRK 1
#define XPAR_MICROBLAZE_3A_NUMBER_OF_RD_ADDR_BRK 0
#define XPAR_MICROBLAZE_3A_NUMBER_OF_WR_ADDR_BRK 0
#define XPAR_MICROBLAZE_3A_INTERRUPT_IS_EDGE 0
#define XPAR_MICROBLAZE_3A_EDGE_IS_POSITIVE 1
#define XPAR_MICROBLAZE_3A_RESET_MSR 0x00000000
#define XPAR_MICROBLAZE_3A_OPCODE_0X0_ILLEGAL 0
#define XPAR_MICROBLAZE_3A_FSL_LINKS 0
#define XPAR_MICROBLAZE_3A_FSL_DATA_SIZE 32
#define XPAR_MICROBLAZE_3A_USE_EXTENDED_FSL_INSTR 0
#define XPAR_MICROBLAZE_3A_ICACHE_BASEADDR 0xA0000000
#define XPAR_MICROBLAZE_3A_ICACHE_HIGHADDR 0xAFFFFFFF
#define XPAR_MICROBLAZE_3A_USE_ICACHE 0
#define XPAR_MICROBLAZE_3A_ALLOW_ICACHE_WR 1
#define XPAR_MICROBLAZE_3A_ADDR_TAG_BITS 0
#define XPAR_MICROBLAZE_3A_CACHE_BYTE_SIZE 8192
#define XPAR_MICROBLAZE_3A_ICACHE_USE_FSL 1
#define XPAR_MICROBLAZE_3A_ICACHE_LINE_LEN 4
#define XPAR_MICROBLAZE_3A_ICACHE_ALWAYS_USED 0
#define XPAR_MICROBLAZE_3A_DCACHE_BASEADDR 0x00000000
#define XPAR_MICROBLAZE_3A_DCACHE_HIGHADDR 0x3FFFFFFF
#define XPAR_MICROBLAZE_3A_USE_DCACHE 0
#define XPAR_MICROBLAZE_3A_ALLOW_DCACHE_WR 1
#define XPAR_MICROBLAZE_3A_DCACHE_ADDR_TAG 0
#define XPAR_MICROBLAZE_3A_DCACHE_BYTE_SIZE 8192
#define XPAR_MICROBLAZE_3A_DCACHE_USE_FSL 1
#define XPAR_MICROBLAZE_3A_DCACHE_LINE_LEN 4
#define XPAR_MICROBLAZE_3A_DCACHE_ALWAYS_USED 0
#define XPAR_MICROBLAZE_3A_USE_MMU 0
#define XPAR_MICROBLAZE_3A_MMU_DTLB_SIZE 4
#define XPAR_MICROBLAZE_3A_MMU_ITLB_SIZE 2
#define XPAR_MICROBLAZE_3A_MMU_TLB_ACCESS 3
#define XPAR_MICROBLAZE_3A_MMU_ZONES 16
#define XPAR_MICROBLAZE_3A_USE_INTERRUPT 0
#define XPAR_MICROBLAZE_3A_USE_EXT_BRK 1
#define XPAR_MICROBLAZE_3A_USE_EXT_NM_BRK 1
