------------------------------------------------------------------------------
-- plb_cond_vars.vhd - entity/architecture pair
------------------------------------------------------------------------------
-- IMPORTANT:
...
library plb_cond_vars_v1_00_a;
use plb_cond_vars_v1_00_a.user_logic;
...
end entity plb_cond_vars;

------------------------------------------------------------------------------
-- Architecture section
------------------------------------------------------------------------------

architecture IMP of plb_cond_vars is
...
begin
  ...
  ------------------------------------------
  USER_LOGIC_I : entity plb_cond_vars_v1_00_a.user_logic
    generic map
    (
