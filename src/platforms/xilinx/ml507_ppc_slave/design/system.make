...
# /home/eugene/hthreads/src/platforms/xilinx/ml507_ppc_slave/design/system.mhs
# The software specification of the system is in file :
# /home/eugene/hthreads/src/platforms/xilinx/ml507_ppc_slave/design/system.mss
...
host_microblaze_libsclean:
	rm -rf host_microblaze/
...
Test_Memory_App_program: $(TEST_MEMORY_APP_OUTPUT) 

$(TEST_MEMORY_APP_OUTPUT) : $(TEST_MEMORY_APP_SOURCES) $(TEST_MEMORY_APP_HEADERS) $(TEST_MEMORY_APP_LINKER_SCRIPT) \
                    $(LIBRARIES) __xps/test_memory_app_compiler.opt
	@mkdir -p $(TEST_MEMORY_APP_OUTPUT_DIR) 
	$(TEST_MEMORY_APP_CC) $(TEST_MEMORY_APP_CC_OPT) $(TEST_MEMORY_APP_SOURCES) -o $(TEST_MEMORY_APP_OUTPUT) \
	$(TEST_MEMORY_APP_OTHER_CC_FLAGS) $(TEST_MEMORY_APP_INCLUDES) $(TEST_MEMORY_APP_LIBPATH) \
	$(TEST_MEMORY_APP_CFLAGS) $(TEST_MEMORY_APP_LFLAGS) 
	$(TEST_MEMORY_APP_CC_SIZE) $(TEST_MEMORY_APP_OUTPUT) 
	@echo ""

Test_Memory_App_programclean:
	rm -f $(TEST_MEMORY_APP_OUTPUT) 
...
$(HOST_MICROBLAZE_BOOTLOOP): $(MICROBLAZE_BOOTLOOP)
	@mkdir -p $(BOOTLOOP_DIR)
	cp -f $(MICROBLAZE_BOOTLOOP) $(HOST_MICROBLAZE_BOOTLOOP)
