...
set_property -dict [list  CONFIG.C_FSL_LINKS {1} CONFIG.C_D_AXI {1} CONFIG.C_USE_BARREL {1} CONFIG.C_PVR {2} CONFIG.C_PVR_USER2 {0xC0000000}  CONFIG.C_PVR_USER1 0x[format "%02x" [expr $j * $C + $i]]  CONFIG.C_USE_ICACHE {1} CONFIG.C_DEBUG_ENABLED {2} CONFIG.C_DEBUG_EVENT_COUNTERS {8} CONFIG.C_DEBUG_LATENCY_COUNTERS {2}]  [get_bd_cells $slave/microblaze_1] 
