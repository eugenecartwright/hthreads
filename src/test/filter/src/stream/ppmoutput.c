...
void ppmoutput_check_buffers( stream_node_t *node )
{
...
void ppmoutput_capture_time( hthread_time_t *s, hthread_time_t *e, Huint *f )
{
    hthread_time_t diff;
    double sec;
...
void ppmoutput_write_file( framebuffer_t *frame )
{
    framebuffer_ppmout( frame, "image.ppm" );
}
